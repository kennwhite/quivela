    ...
    Equivalent_AllMethods(ctx1, ctx2, addr1, addr2, invariant8)
{
    ...
    assert Equivalent(rhs, lhs, ctxp, invariant8) by {
      ...
      assert UnusedIn(newField.name, lhs.body) by {
       ...
       // see etm-step8-eval.dfy
       assume false;
      }
      EquivalentAddNewField(prefix, rhs.locals, rhs.body, newField, invariant8, 0);
    }
